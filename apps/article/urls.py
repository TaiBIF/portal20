...
urlpatterns = [
    path('', views.article_search, name='article-search'),
    path('search/', views.article_search, name='article-search-legacy'),
    ...
    path('data_case', views.data_case, name='article-data-case')
]

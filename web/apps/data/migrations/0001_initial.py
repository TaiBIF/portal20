    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Private', 'Private'), ('Public', 'Public')], max_length=10, verbose_name='status')),
                ...
                ('versione', models.TextField(blank=True, null=True)),
                ...
                ('gbif_mod_date', models.DateTimeField(verbose_name='Modified Date from gbif')),
